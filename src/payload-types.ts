...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'request-lines': RequestLinesSelect<false> | RequestLinesSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "request-lines".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "request-lines_select".
 */
export interface RequestLinesSelect<T extends boolean = true> {
  title?: T;
  requestTotal?: T;
  requestedBy?: T;
  description?: T;
